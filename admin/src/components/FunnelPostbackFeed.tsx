            ...
            {rows.map((row) => (
              <tr key={row.id} className="border-b border-zinc-50 hover:bg-zinc-50/50">
                ...
                <Td>
                  <div className="flex items-center gap-1.5">
                    ...
                    {row.mediagoCode != null && (
                      <span className="text-[10px] text-zinc-400 font-mono">({row.mediagoCode})</span>
                    )}
                  </div>
                  <span className="text-[10px] text-zinc-400 font-mono">{row.eventType}</span>
                </Td>
                ...
                <Td className="max-w-[280px]">
                  <div className="font-mono text-[10px] break-all text-zinc-600 line-clamp-2" title={row.url}>
                    {row.url}
                  </div>
                </Td>
              </tr>
